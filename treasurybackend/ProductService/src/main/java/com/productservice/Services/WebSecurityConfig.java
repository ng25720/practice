...
import com.productservice.jwt.AuthEntryPointJwt;
import com.productservice.jwt.AuthTokenFilter;
   ...
   @Override
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests().antMatchers("/api/v1/auth/resetPassword/**").permitAll().and()
                .authorizeRequests().antMatchers("/api/v1/auth/tempPassword/**").permitAll().and()
